...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/eddygordonn`;
    > Exemplo: `git checkout -b feat/community/eddygordonn`
...
10. Crie um **Pull Request** `Pull Request 2`.
